...
$students = $db->getSomeStudent(1,3);
?>
            ...
            <div class="item <?php if ($i == 1)echo "active"; $i++; ?>">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>成为本站第<code><?php echo $student->getId();?></code>个注册用户，拥有的特权为：免费发表修改留言，2G云盘共享空间，永久保存文件</p>
...
<!--                        <input type="text" class="form-control" placeholder="发表留言">-->
                        <form action="message-server.php" method="post">
            ...
            <div class="alert alert-success">
                <h2 class="glyphicon glyphicon-star">
                    <small class="text-warning">
                        <?php $username = $db->getStudent($message->getUserId())->getName();echo $username;?>
                    </small>
                    <small class="glyphicon glyphicon-film"> </small>
                    <small class="glyphicon glyphicon-globe"> </small>
                </h2>
                <div class="alert-info">
                    <h4 style="margin-top: 20px;" class="text-info"><?php echo $message->getContent();?></h4>
                    <h3>
                ...
                <p class="text-right">用户 <?php echo $username;?>发表于：<?php echo $message->getCreateTime();?></p>
            </div>
        <?php endforeach; ?>
